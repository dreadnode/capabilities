...
The [README](README.md) is the author-facing guide for the `capability.yaml` manifest, components (agents / skills / tools / MCP), and discovery rules. Read it before adding or restructuring a capability.

---

## Layout

Top-level orgs (`dreadnode/`, `ghostsecurity/`, `trailofbits/`, `web-security/`) own their capability subtrees. A capability is a directory with `capability.yaml` plus any combination of `agents/`, `skills/`, `tools/`, `mcp/`, `workers/`, `docs/`.
