# Customizing the Web Security Capability

This directory defines the **web-security** capability — a bundle of tools, skills, hooks,
commands, and system prompt customizations for the web security testing agent. The agent
uses the same dreadnode runtime and loads this capability at startup.
