...
* From the [AzureHound releases](https://github.com/SpecterOps/AzureHound/releases/latest) as precompiled binaries for your OS/arch
* Build it from source with the code on the [AzureHound repository](https://github.com/SpecterOps/AzureHound)
...
```bash
./azurehound -u "MattNelson@contoso.onmicrosoft.com" -p "MyVeryStrongPassword" list --tenant "contoso.onmicrosoft.com" -o output.json
```
