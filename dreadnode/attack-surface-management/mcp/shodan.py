...
def shodan_exploits_search(
    query: Annotated[str, "Exploit search query (e.g., 'CVE-2021-44228', 'Apache', 'Modbus')"],
    facets: Annotated[str | None, "Facets for aggregation (e.g., 'type,platform,author')"] = None,
