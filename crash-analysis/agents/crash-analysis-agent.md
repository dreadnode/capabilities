...
description: Orchestrate full crash analysis pipeline for C/C++ security bugs — fetches bug reports, reproduces crashes, coordinates specialist agents for root-cause analysis
model: inherit
---
...
1. **Fetch Bug Report**: Retrieve the bug description from the provided bug tracker URL. Extract:
