[Skip to content](https://github.com/aidansteele/osx-abi-macho-file-format-reference#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/aidansteele/osx-abi-macho-file-format-reference) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/aidansteele/osx-abi-macho-file-format-reference) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/aidansteele/osx-abi-macho-file-format-reference) to refresh your session.Dismiss alert

{{ message }}

[aidansteele](https://github.com/aidansteele)/ **[osx-abi-macho-file-format-reference](https://github.com/aidansteele/osx-abi-macho-file-format-reference)** Public

- [Notifications](https://github.com/login?return_to=%2Faidansteele%2Fosx-abi-macho-file-format-reference) You must be signed in to change notification settings
- [Fork\\
170](https://github.com/login?return_to=%2Faidansteele%2Fosx-abi-macho-file-format-reference)
- [Star\\
875](https://github.com/login?return_to=%2Faidansteele%2Fosx-abi-macho-file-format-reference)


master

[**1** Branch](https://github.com/aidansteele/osx-abi-macho-file-format-reference/branches) [**0** Tags](https://github.com/aidansteele/osx-abi-macho-file-format-reference/tags)

[Go to Branches page](https://github.com/aidansteele/osx-abi-macho-file-format-reference/branches)[Go to Tags page](https://github.com/aidansteele/osx-abi-macho-file-format-reference/tags)
...
| --- | --- | --- | --- |
| ## Latest commit<br>![lovelace08](https://avatars.githubusercontent.com/u/202493980?v=4&size=40)![aidansteele](https://avatars.githubusercontent.com/u/369053?v=4&size=40)<br>[lovelace08](https://github.com/aidansteele/osx-abi-macho-file-format-reference/commits?author=lovelace08)<br>and<br>[aidansteele](https://github.com/aidansteele/osx-abi-macho-file-format-reference/commits?author=aidansteele)<br>[Update README.md](https://github.com/aidansteele/osx-abi-macho-file-format-reference/commit/ba50f3d01b95e77b4fe9e7b3c3996e5cde4b3a04)<br>2 years agoOct 13, 2024<br>[ba50f3d](https://github.com/aidansteele/osx-abi-macho-file-format-reference/commit/ba50f3d01b95e77b4fe9e7b3c3996e5cde4b3a04) · 2 years agoOct 13, 2024<br>## History<br>[17 Commits](https://github.com/aidansteele/osx-abi-macho-file-format-reference/commits/master/) <br>Open commit details<br>[View commit history for this file.](https://github.com/aidansteele/osx-abi-macho-file-format-reference/commits/master/) 17 Commits |
| [Mach-O\_File\_Format.pdf](https://github.com/aidansteele/osx-abi-macho-file-format-reference/blob/master/Mach-O_File_Format.pdf "Mach-O_File_Format.pdf") | [Mach-O\_File\_Format.pdf](https://github.com/aidansteele/osx-abi-macho-file-format-reference/blob/master/Mach-O_File_Format.pdf "Mach-O_File_Format.pdf") | [Original Apple PDF](https://github.com/aidansteele/osx-abi-macho-file-format-reference/commit/6451b79d2fa703ce2480cd891bf4b3c7bb503120 "Original Apple PDF") | 10 years agoOct 17, 2016 |
| [README.md](https://github.com/aidansteele/osx-abi-macho-file-format-reference/blob/master/README.md "README.md") | [README.md](https://github.com/aidansteele/osx-abi-macho-file-format-reference/blob/master/README.md "README.md") | [Update README.md](https://github.com/aidansteele/osx-abi-macho-file-format-reference/commit/ba50f3d01b95e77b4fe9e7b3c3996e5cde4b3a04 "Update README.md") | 2 years agoOct 13, 2024 |
| View all files |

## Repository files navigation

Preamble: I couldn't find this anywhere on Apple's developer documentation website, so I've copied it here for my own benefit. If you are going to use this page, I highly recommend the table of contents view in GitHub.

# OS X ABI Mach-O File Format Reference

[Permalink: OS X ABI Mach-O File Format Reference](https://github.com/aidansteele/osx-abi-macho-file-format-reference#os-x-abi-mach-o-file-format-reference)
...
[Permalink: Basic Structure](https://github.com/aidansteele/osx-abi-macho-file-format-reference#basic-structure)

A Mach-O file contains three major regions (as shown in Figure 1):

- At the beginning of every Mach-O file is a _header structure_ that identifies the file as a Mach-O file. The header also contains other basic file type information, indicates the target architecture, and contains flags specifying options that affect the interpretation of the rest of the file.
- Directly following the header are a series of variable-size _load commands_ that specify the layout and linkage characteristics of the file. Among other information, the load commands can specify:
...
- Following the load commands, all Mach-O files contain the data of one or more segments. Each _segment_ contains zero or more sections. Each _section_ of a segment contains code or data of some particular type. Each segment defines a region of virtual memory that the dynamic linker maps into the address space of the process. The exact number and layout of segments and sections is specified by the load commands and the file type.
- In user-level fully linked Mach-O files, the last segment is the _link edit_ segment. This segment contains the tables of link edit information, such as the symbol table, string table, and so forth, used by the dynamic loader to link an executable file or Mach-O bundle to its dependent libraries.
...
[Permalink: Header Structure and Load Commands](https://github.com/aidansteele/osx-abi-macho-file-format-reference#header-structure-and-load-commands)
...
[Permalink: Segments](https://github.com/aidansteele/osx-abi-macho-file-format-reference#segments)
...
[Permalink: Sections](https://github.com/aidansteele/osx-abi-macho-file-format-reference#sections)
...
[Permalink: Table 1: The sections of a __TEXT segment](https://github.com/aidansteele/osx-abi-macho-file-format-reference#table-1-the-sections-of-a__textsegment)
...
| `__TEXT,__picsymbol_stub` | Position-independent indirect symbol stubs. See “ [Position-Independent Code](https://developer.apple.com/library/mac/documentation/DeveloperTools/Conceptual/MachOTopics/1-Articles/dynamic_code.html#//apple_ref/doc/uid/TP40002528)” in _Mach-O Programming Topics_ for more information. |
| `__TEXT,__symbol_stub` | Indirect symbol stubs. See “ [Position-Independent Code](https://developer.apple.com/library/mac/documentation/DeveloperTools/Conceptual/MachOTopics/1-Articles/dynamic_code.html#//apple_ref/doc/uid/TP40002528)” in _Mach-O Programming Topics_ for more information. |
...
[Permalink: Table 3: The sections of a __IMPORT segment](https://github.com/aidansteele/osx-abi-macho-file-format-reference#table-3-the-sections-of-a__importsegment)
...
[Permalink: Data Types](https://github.com/aidansteele/osx-abi-macho-file-format-reference#data-types)

### Header Data Structure

[Permalink: Header Data Structure](https://github.com/aidansteele/osx-abi-macho-file-format-reference#header-data-structure)

#### `mach_header`

[Permalink: mach_header](https://github.com/aidansteele/osx-abi-macho-file-format-reference#mach_header)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields)
...
[Permalink: mach_header_64](https://github.com/aidansteele/osx-abi-macho-file-format-reference#mach_header_64)

Defines the general attributes of a file targeted for a 64-bit architecture. Declared in `/usr/include/mach-o/loader.h`.

###### Declaration

[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-1)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-1)
...
[Permalink: Load Command Data Structures](https://github.com/aidansteele/osx-abi-macho-file-format-reference#load-command-data-structures)
...
[Permalink: load_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#load_command)

Contains fields that are common to all load commands.

##### Declaration

[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-2)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-2)
...
[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion)
...
[Permalink: Table 4: Mach-O load commands](https://github.com/aidansteele/osx-abi-macho-file-format-reference#table-4-mach-o-load-commands)
...
[Permalink: uuid_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#uuid_command)

Specifies the 128-bit universally unique identifier (UUID) for an image or for its corresponding dSYM file.

##### Declaration

[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-3)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-3)
...
[Permalink: segment_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#segment_command)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-4)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-4)
...
[Permalink: segment_command_64](https://github.com/aidansteele/osx-abi-macho-file-format-reference#segment_command_64)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-5)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-5)
...
[Permalink: section](https://github.com/aidansteele/osx-abi-macho-file-format-reference#section)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-6)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-6)
...
[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion-1)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-7)
...
[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion-2)
...
[Permalink: twolevel_hints_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#twolevel_hints_command)

Defines the attributes of a `LC_TWOLEVEL_HINTS` load command. Declared in `/usr/include/mach-o/loader.h`.

##### Declaration

[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-8)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-8)
...
[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion-3)
...
[Permalink: twolevel_hint](https://github.com/aidansteele/osx-abi-macho-file-format-reference#twolevel_hint)

Specifies an entry in the two-level namespace hint table. Declared in `/usr/include/mach-o/loader.h`.

##### Declaration

[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-9)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-9)
...
[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion-4)
...
[Permalink: lc_str](https://github.com/aidansteele/osx-abi-macho-file-format-reference#lc_str)

Defines a variable-length string. Declared in `/usr/include/mach-o/loader.h`.

##### Declaration

[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-10)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-10)
...
[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion-5)
...
[Permalink: dylib](https://github.com/aidansteele/osx-abi-macho-file-format-reference#dylib)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-11)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-11)
...
[Permalink: dylib_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#dylib_command)

Defines the attributes of the `LC_LOAD_DYLIB` and `LC_ID_DYLIB` load commands. Declared in `/usr/include/mach-o/loader.h`.

##### Declaration

[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-12)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-12)
...
[Permalink: dylinker_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#dylinker_command)

Defines the attributes of the `LC_LOAD_DYLINKER` and `LC_ID_DYLINKER` load commands. Declared in `/usr/include/mach-o/loader.h`.

##### Declaration

[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-13)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-13)
...
[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion-7)
...
[Permalink: prebound_dylib_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#prebound_dylib_command)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-14)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-14)
...
[Permalink: thread_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#thread_command)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-15)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-15)
...
[Permalink: routines_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#routines_command)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-16)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-16)
...
[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion-8)
...
[Permalink: routines_command_64](https://github.com/aidansteele/osx-abi-macho-file-format-reference#routines_command_64)

Defines the attributes of the `LC_ROUTINES_64` load command, used in 64-bit architectures. Describes the location of the shared library initialization function, which is a function that the dynamic linker calls before allowing any of the routines in the library to be called. Declared in `/usr/include/mach-o/loader.h`.

##### Declaration

[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-17)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-17)
...
[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion-9)
...
[Permalink: sub_framework_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#sub_framework_command)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-18)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-18)
...
[Permalink: sub_umbrella_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#sub_umbrella_command)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-19)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-19)
...
[Permalink: sub_library_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#sub_library_command)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-20)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-20)
...
[Permalink: sub_client_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#sub_client_command)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-21)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-21)
...
[Permalink: Symbol Table and Related Data Structures](https://github.com/aidansteele/osx-abi-macho-file-format-reference#symbol-table-and-related-data-structures)
...
[Permalink: symtab_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#symtab_command)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-22)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-22)
...
[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion-10)

`LC_SYMTAB` should exist in both statically linked and dynamically linked file types.

#### `nlist`

[Permalink: nlist](https://github.com/aidansteele/osx-abi-macho-file-format-reference#nlist)

Describes an entry in the symbol table for 32-bit architectures. Declared in `/usr/include/mach-o/nlist.h`. See also `nlist_64`.

##### Declaration

[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-23)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-23)
...
[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion-11)
...
[Permalink: nlist_64](https://github.com/aidansteele/osx-abi-macho-file-format-reference#nlist_64)

Describes an entry in the symbol table for 64-bit architectures. Declared in `/usr/include/mach-o/nlist.h`.

##### Declaration

[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-24)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-24)
...
[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion-12)

See discussion in `nlist`.

#### `dysymtab_command`

[Permalink: dysymtab_command](https://github.com/aidansteele/osx-abi-macho-file-format-reference#dysymtab_command)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-25)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-25)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-26)
...
[Permalink: dylib_module](https://github.com/aidansteele/osx-abi-macho-file-format-reference#dylib_module)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-27)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-27)
...
[Permalink: dylib_module_64](https://github.com/aidansteele/osx-abi-macho-file-format-reference#dylib_module_64)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-28)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-28)
...
[Permalink: dylib_reference](https://github.com/aidansteele/osx-abi-macho-file-format-reference#dylib_reference)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-29)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-29)
...
[Permalink: Relocation Data Structures](https://github.com/aidansteele/osx-abi-macho-file-format-reference#relocation-data-structures)

_Relocation_ is the process of moving symbols to a different address. When the static linker moves a symbol (a function or an item of data) to a different address, it needs to change all the references to that symbol to use the new address. The _relocation entries_ in a Mach-O file contain offsets in the file to addresses that need to be relocated when the contents of the file are relocated. The addresses stored in CPU instructions can be absolute or relative. Each relocation entry specifies the exact format of the address. When creating the intermediate object file, the compiler generates one or more relocation entries for every instruction that contains an address. Because relocation to symbols at fixed addresses, and to relative addresses for position independent references, does not occur at runtime, the static linker typically removes some or all the relocation entries when building the final product.
...
[Permalink: relocation_info](https://github.com/aidansteele/osx-abi-macho-file-format-reference#relocation_info)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-30)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-30)
...
Indicates the length of the item containing the address to be relocated. The following table lists r\_length values and the corresponding address length.
...
- `PPC_RELOC_LO16`—The instruction contains the low 16 bits of an address. The next relocation entry must be a `PPC_RELOC_PAIR` specifying the high 16 bits of the expression in the low ( _not_ the high) 16 bits of the `r_value` field.
...
- `PPC_RELOC_LOCAL_SECTDIFF`—Similar to PPC\_RELOC\_SECTDIFF except that this entry refers specifically to the address in this item. If the address is that of a globally visible coalesced symbol, this relocation entry does not change if the symbol is overridden. This is used to associate stack unwinding information with the object code this relocation entry describes
...
[Permalink: scattered_relocation_info](https://github.com/aidansteele/osx-abi-macho-file-format-reference#scattered_relocation_info)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-31)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-31)
...
[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion-14)

Mach-O relocation data structures support two types of relocatable expressions in machine code and data:

- _Symbol address + constant_. The most typical form of relocation is referencing a symbol’s address with no constant added. In this case, the value of the constant expression is 0.
- _Address of section y – address of section x + constant_. The section difference form of relocation. This form of relocation supports position-independent code.

## Universal Binaries and 32-bit/64-bit PowerPC Binaries

[Permalink: Universal Binaries and 32-bit/64-bit PowerPC Binaries](https://github.com/aidansteele/osx-abi-macho-file-format-reference#universal-binaries-and-32-bit64-bit-powerpc-binaries)
...
[Permalink: fat_header](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fat_header)
...
[Permalink: Declaration](https://github.com/aidansteele/osx-abi-macho-file-format-reference#declaration-32)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-32)

`magic`

An integer containing the value 0xCAFEBABE in big-endian byte order format. On a big-endian host CPU, this can be validated using the constant FAT\_MAGIC; on a little-endian host CPU, it can be validated using the constant FAT\_CIGAM.

`nfat_arch`

##### Discussion

[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion-15)

The fat\_header data structure is placed at the start of a binary that contains code for multiple architectures. Directly following the fat\_header data structure is a set of `fat_arch` data structures, one for each architecture included in the binary. Regardless of the content this data structure describes, all its fields are stored in big-endian byte order.

#### `fat_arch`

[Permalink: fat_arch](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fat_arch)
...
[Permalink: Fields](https://github.com/aidansteele/osx-abi-macho-file-format-reference#fields-33)

`cputype`

An enumeration value of type cpu\_type\_t. Specifies the CPU family.

`cpusubtype`

An enumeration value of type cpu\_subtype\_t. Specifies the specific member of the CPU family on which this entry may be used or a constant specifying all members.
...
[Permalink: Discussion](https://github.com/aidansteele/osx-abi-macho-file-format-reference#discussion-16)
...
[apple](https://github.com/topics/apple "Topic: apple") [osx](https://github.com/topics/osx "Topic: osx") [mach-o](https://github.com/topics/mach-o "Topic: mach-o") [abi](https://github.com/topics/abi "Topic: abi")

### Resources

[Readme](https://github.com/aidansteele/osx-abi-macho-file-format-reference#readme-ov-file)

### Uh oh!

There was an error while loading. [Please reload this page](https://github.com/aidansteele/osx-abi-macho-file-format-reference).

[Activity](https://github.com/aidansteele/osx-abi-macho-file-format-reference/activity)

### Stars

[**875**\\
stars](https://github.com/aidansteele/osx-abi-macho-file-format-reference/stargazers)

### Watchers

[**16**\\
watching](https://github.com/aidansteele/osx-abi-macho-file-format-reference/watchers)

### Forks

[**170**\\
forks](https://github.com/aidansteele/osx-abi-macho-file-format-reference/forks)

[Report repository](https://github.com/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2Faidansteele%2Fosx-abi-macho-file-format-reference&report=aidansteele+%28user%29)

## [Releases](https://github.com/aidansteele/osx-abi-macho-file-format-reference/releases)

No releases published

## [Packages\  0](https://github.com/users/aidansteele/packages?repo_name=osx-abi-macho-file-format-reference)
...
## [Contributors\  3](https://github.com/aidansteele/osx-abi-macho-file-format-reference/graphs/contributors)

- [![@aidansteele](https://avatars.githubusercontent.com/u/369053?s=64&v=4)](https://github.com/aidansteele)[**aidansteele** Aidan Steele](https://github.com/aidansteele)
- [![@0xbf00](https://avatars.githubusercontent.com/u/4608543?s=64&v=4)](https://github.com/0xbf00)[**0xbf00** Jakob](https://github.com/0xbf00)
- [![@jeremy-rifkin](https://avatars.githubusercontent.com/u/51220084?s=64&v=4)](https://github.com/jeremy-rifkin)[**jeremy-rifkin** Jeremy Rifkin](https://github.com/jeremy-rifkin)
