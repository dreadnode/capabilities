...
When you find a vulnerability, your report will be reviewed by a senior pentester. Weak evidence leads to rejection and penalties.
...
- When classifying a vulnerability, you should use phrasing such as " [Vulnerability Type] in [Location/Component] Leads to [Impact]"
