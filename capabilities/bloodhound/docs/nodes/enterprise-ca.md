...
| Enrollment Agent Restrictions Collected | enrollmentagentrestrictions  <br/>collected | -   | Whether the EnrollmentAgentRights ACL stored in registry of the CA host has been collected. |
...
| Has Enrollment Agent Restrictions | hasenrollmentagent  <br/>restrictions | -   | Whether the enrollment agent restrictions are enabled. |
| Is User Specifies San Enabled Collected | isuserspecifiessanenabled  <br/>collected | -   | Whether the EditFlags registry value of the CA host has been collected. |
...
| Role Separation Enabled Collected | roleseparationenabled  <br/>collected | -   | Whether the RoleSeparationEnabled registry value of the CA host has been collected. |
