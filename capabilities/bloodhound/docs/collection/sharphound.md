...
* From the [SharpHound releases](https://github.com/SpecterOps/SharpHound/releases/latest) as precompiled binaries
* Build it from source with the code on the [SharpHound repository](https://github.com/SpecterOps/SharpHound)
