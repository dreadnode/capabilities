...
`rce_evidence_gate`, `approval_bypassed`, `trusted_proxy_exfil_detected`, `covert_channel_capacity`, `minja_activation_detected`, `line_jump_fired`, `poison_retrieved_and_steered`, `infection_propagation`
