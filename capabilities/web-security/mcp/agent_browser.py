...
def _js_execution_verdict(state: dict, expected_token: str) -> dict:
...
async def agent_browser_start_js_execution_proof(
    ...
    This proves payload-controlled JavaScript execution, not HTML reflection,
    screenshots, or API echoing. Use it for XSS classes by adapting one returned
    payload to the suspected sink, then check the proof after rendering.
    """
